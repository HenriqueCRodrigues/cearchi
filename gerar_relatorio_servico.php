...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <title>Cearchi - Gerar Relatório de Serviço</title>
...
<div id="fh5co-page">
          ...
          <div class="dreamcrub">
           <ul class="breadcrumbs">
                   <li class="home">
                    ...
                    <li class="women">
                        <font color="white"> Relatório por Serviço </font>
                    </li>
                </ul>
                <ul class="previous">
		...
		<div class="container">
			<div class="row">
				<div class="Register-form">
					<x3>Gerar relatório por serviço</x3>
					<p>Os relatórios por serviço oferecem informações sobre a quantidade de vezes que cada serviço foi prestado em um determinado período!</p><br><br>

				</div>
				
					 <form method="post" action="Resultado_relatorio_servico.php">
					...
					<div class="row">
						...
						<div class="col-md-6">
            <li class="text-info" style="list-style-type:none"> Região: </li>
                <div class="form-group"> 
  <select class="form-control3" name="regiao" id="regiao">
  <option value="">&nbsp;&nbspSelecione</option>
   ...
   <?php
      ...
      {
        $id_estado = $array['cod_estados'];
        $nome_estado = $array['nome'];
    ...
    ?>	
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<p class="click">Clicando no botão "Gerar relatório", você estará gerando um relatório por região no período selecionado.</a></p> 
							</div>
						</div>
					</div>
				</div>
