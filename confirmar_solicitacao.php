<?php
	...
	{
		$sql = mysql_query("INSERT INTO solicitacao_de_servico (data_ss, hora_ss, fk_id_ts, fk_id_user_contratante, fk_id_user_prestador, status_ss) values ('$data', '$hora', '$id_ts', '$id', '$id_terceiro', 'A')");
