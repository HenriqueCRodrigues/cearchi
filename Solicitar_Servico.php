...
<form method="post" action="Confirmar_Cadastro.php">
    ...
    <input type="checkbox" name="tipo_ss" value="EN" checked>Encanador<br>
    <input type="checkbox" name="tipo_ss" value="PE" checked>Pedreiro<br>
    ...
    Data de visita: <input type="Date" name="data_ss" id="data_ss"><br /><br />
    Horario de visita: <input type="time" name="hora_ss" id="hora_ss"><br /><br />




    <input type="submit" value="Solicitar" id="btnCad" onclick="Cadastro()">
