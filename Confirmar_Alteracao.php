...
//Gravando no banco de dados !
 ...
 if (strcmp($nome_user, '') == 0 ||  strcmp($telefone_user, '') == 0 ||  strcmp($email_user, '') == 0 || strcmp($rua_user, '') == 0 || strcmp($numero_user, 0) == 0 || strcmp($bairro_user, '') == 0 ||  strcmp($cidade_user, '') == 0 || strcmp($estado_user, '') == 0 || strcmp($cep_user, '') == 0) 
	{
	// Script de Alerta
